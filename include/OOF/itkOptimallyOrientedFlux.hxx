...
template <typename TInputImage, typename TOutputImage>
itk::Image<double,3>::Pointer itk::OptimallyOrientedFlux<TInputImage,TOutputImage>::ifftShiftedCoordMatrixY(typename TInputImage::SizeType dimension,typename TInputImage::SpacingType spacing,typename TInputImage::PointType origin)
{    
    CoordImageType::SizeType p;
    p[0] = std::floor(dimension[0]/2.0);
    p[1] = std::floor(dimension[1]/2.0);
...
template <typename TInputImage, typename TOutputImage>
itk::Image<double,3>::Pointer itk::OptimallyOrientedFlux<TInputImage,TOutputImage>::ifftShiftedCoordMatrixZ(typename TInputImage::SizeType dimension,typename TInputImage::SpacingType spacing, typename TInputImage::PointType origin)
{
    CoordImageType::SizeType p;
    p[0] = std::floor(dimension[0]/2.0);
    p[1] = std::floor(dimension[1]/2.0);
...
template<typename TInputImage, typename TOutputImage>
itk::Image<double,3>::Pointer itk::OptimallyOrientedFlux<TInputImage,TOutputImage>::ifftshiftedcoordinate(typename TInputImage::SizeType dimension,int index,typename TInputImage::SpacingType spacing, typename TInputImage::PointType origin)
{
...
template <typename TInputImage, typename TOutputImage>
std::vector<itk::Image<double,3>::Pointer> itk::OptimallyOrientedFlux<TInputImage,TOutputImage>::ifftShiftedCoordMatrix(typename TInputImage::SizeType dimension,typename TInputImage::SpacingType spacing,typename TInputImage::PointType origin)
{
    ...
    for(auto &rad : m_radii)
    {
        ...
        for(int i=0;i<3;i++)
            for(int j=i;j<3;j++)
            {
                ...
                // triple check at this points values are the same as matlab (rounding error apearing at e10-8)
