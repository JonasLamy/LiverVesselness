...
// TODO Check licensing stuff
// files modified by Jonas Lamy

#ifndef itkDgMultiScaleHessianBasedMeasureImageFilter_h
#define itkDgMultiScaleHessianBasedMeasureImageFilter_h
 ...
 * \sa HessianDiscreteGaussianImageFilter
...
class ITK_TEMPLATE_EXPORT DgMultiScaleHessianBasedMeasureImageFilter:
  public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(DgMultiScaleHessianBasedMeasureImageFilter);

  /** Standard class type aliases. */
  using Self = DgMultiScaleHessianBasedMeasureImageFilter;
  ...
  using HessianFilterType = HessianDiscreteGaussianImageFilter< InputImageType, HessianImageType >;
  ...
  itkTypeMacro(DgMultiScaleHessianBasedMeasureImageFilter,
               ImageToImageFilter);
...
protected:
  DgMultiScaleHessianBasedMeasureImageFilter();
  ~DgMultiScaleHessianBasedMeasureImageFilter() override = default;
...
#include "itkDgMultiScaleHessianBasedMeasureImageFilter.hxx"
#endif
