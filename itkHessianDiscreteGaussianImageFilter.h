...
// FIle modified by Jonas Lamy
#ifndef itkHessianDiscreteGaussianImageFilter_h
#define itkHessianDiscreteGaussianImageFilter_h
...
template< typename TInputImage,
          typename TOutputImage = Image< SymmetricSecondRankTensor<
                                         ...
                                         TInputImage::ImageDimension > >
class ITK_TEMPLATE_EXPORT HessianDiscreteGaussianImageFilter:
  public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(HessianDiscreteGaussianImageFilter);

  /** Standard class type aliases. */
  using Self = HessianDiscreteGaussianImageFilter;
  ...
  using GaussianFilterType = DiscreteGaussianDerivativeImageFilter<
    RealImageType, RealImageType >;

  /**  Derivative filter type, it will be the first in the pipeline  */
  using DerivativeFilterAType = DiscreteGaussianDerivativeImageFilter<
    InputImageType, RealImageType >;

  using DerivativeFilterBType = DiscreteGaussianDerivativeImageFilter<
    RealImageType, RealImageType >;
   ...
   *  \sa  DiscreteGaussianImageFilter::SetNormalizeAcrossScale
   */
...
protected:
  ...
  ~HessianDiscreteGaussianImageFilter() override = default;
...
#include "itkHessianDiscreteGaussianImageFilter.hxx"
#endif
