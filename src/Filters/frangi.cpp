...
int main( int argc, char* argv[] )
{
  ...
  CLI::App app;
  app.description("This is the frangi algorithm. \n This version automatically set gamma as half the max hessian norm as described in the original paper");
  ...
  if( !maskFile.empty() )
  {
    ...
    objectnessFilter->SetMaskImage(maskImage);
  }
  ...
  // Based on custom framework, frangi now only compute vesselness in masks.
