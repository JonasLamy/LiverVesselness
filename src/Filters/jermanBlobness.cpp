...
#include "itkHessianToJermanBlobnessMeasureImageFilter.h"
...
int main( int argc, char* argv[] )
{
  ...
  CLI::App app;
  app.description("Apply the Jerman Blobness algorithm");
  ...
  app.add_option("--tau,-t", tau, "JermanBlobness tau parameter" ,true);
  ...
  using JermanBlobnessFilterType = itk::HessianToJermanBlobnessMeasureImageFilter<HessianImageType, OutputImageType, MaskImageType>;
  auto jermanFilter = JermanBlobnessFilterType::New();
