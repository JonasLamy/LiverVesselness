...
listLength = 7
# filling lists of masks using file name
...
# set up matplotlib for pdf generations
matplotlib.use("pgf")
...
# Uncomment this section to get the annexe going.
# The annexe print the best metrics per volumes (can be quite long to compute)
"""
